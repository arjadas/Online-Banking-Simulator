export const schema = gql`
  ...
  type Mutation {
    ...
    updateUserPrevContact(user_id: [object]!, input: UpdateUserPrevContactInput!): UserPrevContact! @requireAuth
    deleteUserPrevContact(user_id: [object]!): UserPrevContact! @requireAuth
  }
`

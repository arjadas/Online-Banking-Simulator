export const schema = gql`
  ...
  type Query {
    ...
    userPrevContact(user_id: Int!): UserPrevContact @requireAuth
  }
  ...
  type Mutation {
    ...
    updateUserPrevContact(user_id: Int!, input: UpdateUserPrevContactInput!): UserPrevContact! @requireAuth
    deleteUserPrevContact(user_id: Int!): UserPrevContact! @requireAuth
  }
`

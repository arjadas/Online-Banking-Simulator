  ...
  return (
    <Router>
      ...
      <Set wrap={ScaffoldLayout} title="Transactions" titleTo="transactions" buttonLabel="New Transaction" buttonTo="newTransaction">
        <Route path="/transactions/{transaction_id:Int}/edit" page={TransactionEditTransactionPage} name="editTransaction" />
        <Route path="/transactions/{transaction_id:Int}" page={TransactionTransactionPage} name="transaction" />
      </Set>
      <Set wrap={ScaffoldLayout} title="Transactions" titleTo="transactions" buttonLabel="New Transaction" buttonTo="newTransaction">

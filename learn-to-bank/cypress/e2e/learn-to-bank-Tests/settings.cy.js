  ...
  describe('configure settings', () => {
    ...
    const setSliderValue = (targetValue) => {
      ...
      cy.get('.slider').then(($slider) => {
        ...
        cy.wrap($slider)
          .click(positionX - rect.left, rect.height / 2);
      });
    };
